...
#define BLOCK_SIZE                                                             \
    65536 // Can be 32768 or 65536, choose matching Flash_EraseBlock function
...
void takeBus() {
    CLEAR_BIT(P1,
              1); // Pull FPGA reset line (pin 2.1) low to hold FPGA in reset
...
void endFlashWritePage() { SPIMasterDeassertCS(); }
