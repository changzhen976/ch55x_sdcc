...
static const uint8_t MicroOLED64x48init[] = {
    ...
    SSD1306_SETCOMPINS,
    0x12, // 0x12 if height > 32 else 0x02
    SSD1306_SETCONTRAST,
...
unsigned char microbuffer
    [MICROBUFFER_SIZE]; // a small buffer for tranfering data to the diplay
...
void ssd1306Init() {
    ...
    for (commandIndex = 0; commandIndex < sizeof(MicroOLED64x48init);
         commandIndex++) {
